...
print(denominationOutput(cashPaidByCus, ans5, ans6))
...
# import ClassAFile
# class Name(ClassAFile.ProductInShop) :
#     val1 = int(input("No. Of Items Available In The Shop : "))
#     print(ClassAFile.ProductInShop.itemsAtShopFunc(val1))
#     # val1 = ClassAFile.ProductInShop.itemsAtShop
#     # val2 = ClassAFile.CustomerPurchase.ans2
#     # for i in range(0, ClassAFile.CustomerPurchase.purchasedByCustomer, 1):
#     #     ans3 = ClassAFile.Billing.ans3
#     #     print(ans3[i][0], "|", ans3[i][1], "|", ans3[i][2], "|", ans3[i][3], "|", ans3[i][4], "|", ans3[i][5],
#     #           ans3[i][6])
#     # change1 = ClassAFile.CustomerPurchase.purchasedByCustomer
#     # change2 = ClassAFile.TaxAndPremium.ans4
#     # print(change2[change1 - 1][0])
#     # print(change2[change1 - 1][1])
#     # print(change2[change1 - 1][2])
#     # print(ClassAFile.TaxAndPremium.ans5)
#     #
#     # print(round(ClassAFile.TaxAndPremium.ans5))
#     # print(ClassAFile.Denominations.cashPaidByCus - round(ClassAFile.TaxAndPremium.ans5))
#     # ans7 = ClassAFile.Denominations.denominationOutput(ClassAFile.Denominations.cashPaidByCus, ClassAFile.TaxAndPremium.ans5, ClassAFile.Denominations.ans6)
